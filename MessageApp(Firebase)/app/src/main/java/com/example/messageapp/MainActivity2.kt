...
//            var lower=rName.lowercase()
            ...
            if(!flag) {
                if (rName.isNotEmpty() && phone_number.toString().isNotEmpty()&& phone_number.length==11) {
                    ...
                    CDAO.insertConversation(Conversation(phone_number, sendername, rName,senderphone))
                }
